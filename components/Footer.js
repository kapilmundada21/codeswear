                    ...
                    <div className="flex flex-col md:flex-row justify-center md:justify-evenly space-y-8 md:space-y-0 md:py-4">
                        <div className="w-full md:w-1/4 flex flex-col justify-center transform md:-translate-y-6 space-y-2">
                            <div className="flex space-x-2 justify-center">
                                ...
                                <span className='text-2xl font-semibold'>{process.env.NEXT_PUBLIC_WEBSITE_NAME}</span>
                            </div>
                        ...
                        <div className="w-full md:w-1/4 text-center">
                            <h2 className="title-font font-medium text-gray-900 tracking-widest text-lg mb-3">About Us</h2>
                            <p>
                        ...
                        <div className="w-full md:w-1/4 text-center">
                            <h2 className="title-font font-medium text-gray-900 tracking-widest text-lg mb-3">Quick Links</h2>
                        ...
                        <div className="w-full md:w-1/4 text-center">
                            <h2 className="title-font font-medium text-gray-900 tracking-widest text-lg mb-3">Contact Info</h2>
                            <p>
                                Nashik, Maharashtra, India <br />
                                Pincode - 422010 <br />
                                Email - <Link href='mailto:kapilmundada21@gmail.com' ><a>kapilmundada21@gmail.com</a></Link>
                            </p>
                        </div>
                    </div>
                </div>
