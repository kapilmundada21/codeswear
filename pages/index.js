...
export default function Home({ tshirt, jeans }) {
  return (
    <div>
      ...
      <div className="m-0 mb-12 p-0 w-[100%] h-auto float-left">
        <Image src="/images/home/2.jpg" height="350%" width="755%" alt="4" />
        <Image src="/images/home/1.png" height="350%" width="755%" alt="3" />
        <Image src="/images/home/3.png" height="380%" width="755%" alt="2" />
        <Image src="/images/home/4.png" height="380%" width="755%" alt="5" />
      </div>

      <div className="px-5 md:py-6 mx-auto">
        <div className="flex flex-wrap w-full flex-col items-center text-center">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900"><u>Featured Products</u></h1>
        </div>
      </div>

      <div className="mx-auto p-4 md:px-8 justify-center" >
        <div className="flex justify-between items-center">
          <h1 className='font-bold text-2xl p-4'>T-Shirts</h1>
      ...
      <section className="text-gray-600 body-font mx-4 md:mx-8 my-16 justify-center">
        <div className="flex flex-wrap -m-4 text-center">
          ...
          <div className="w-full xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg hover:bg-slate-300 bg-slate-200">
              <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                <MdLocalShipping className='md:text-xl' />
              </div>
          ...
          <div className="w-full xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg hover:bg-slate-300 bg-slate-200">
              <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                <FaRupeeSign className='md:text-xl' />
              </div>
