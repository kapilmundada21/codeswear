...
export default function Home({ tshirt }) {
  // console.log(tshirt);
  return (
    <div>
      <Head>
        <title>{process.env.NEXT_PUBLIC_WEBSITE_NAME}</title>
        <meta name="description" content={`${process.env.NEXT_PUBLIC_WEBSITE_NAME} is an online Store
        where you can purchase cloths`} />
...
export async function getServerSideProps(context) {
  ...
  return {
      props: { tshirt: JSON.parse(JSON.stringify(tshirt)) }, // will be passed to
  }
}
